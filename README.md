# im-dash-extension-pack

Extend basic dash html library for better support of bootstrap and other html elements
...
5. Find source files
  ...
  - Navigate to `webpack:// -> [your/repo/path]] -> im-dash-extension-pack -> src` to find your component source files.
...
3. Run the dash layout you want to test
        ...
        # Import im-dash-extension-pack to your layout, then run it:
